...
public class SuggestionView extends ViewPart {
	...
	class ViewLabelProvider extends LabelProvider implements
		...
		public String getColumnText(Object obj, int index) {
			...
			return this.getText(suggestion.getSuggestion());
			/*
			switch (index) {
				case 0:
	...
	public void createPartControl(Composite parent) {
		viewer = new TableViewer(parent, SWT.MULTI | SWT.H_SCROLL
				| SWT.V_SCROLL);
		viewer.setContentProvider(RejuvenatePointcutPlugin.getInstance());
		...
		TableColumn suggestionColumn = new TableColumn(table, SWT.LEFT);
		
		TableColumn patternColumn = new TableColumn(table, SWT.LEFT);
